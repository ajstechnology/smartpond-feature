import 'package:smartpond/data/model/response/language_model.dart';

class AppConstants {
  static const String APP_NAME = 'SmartPond';

  static const String BASE_URL = 'https://smartpond.in/admin';
  ...
  static const String TOPIC = 'smartpond';
